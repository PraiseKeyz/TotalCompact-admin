...
const Dashboard = () => {
  ...
  const isActiveRoute = (path: string) => {
    return location.pathname === path
      ...
      : "text-gray-300 hover:bg-tertiary/90 hover:text-white";
  };
    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      ...
      >
        <div className="flex items-center justify-between p-4">
          <h1
            className={`text-white font-bold ${!isSidebarOpen && !isMobile ? "hidden" : "block"}`}
          >
            Total Compact Admin
          </h1>
          {isSidebarOpen && isMobile && (
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 text-tertiary w-6"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
        ...
        <nav className="mt-6 px-4 space-y-2">
          {[
            ...
            },
            {
              ...
              name: "Upload",
              icon: "M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M16 8l-4-4m0 0L8 8m4-4v12",
            },
            {
              path: "/dashboard/manage",
              name: "Manage",
              icon: "M13.615 4.385a1 1 0 011.77 0l1.414 2.828a1 1 0 00.894.554h2.828a1 1 0 010 2h-2.828a1 1 0 00-.894.554l-1.414 2.828a1 1 0 01-1.77 0l-1.414-2.828a1 1 0 00-.894-.554h-2.828a1 1 0 010-2h2.828a1 1 0 00.894-.554l1.414-2.828z",
            },
          ].map((item) => (
            <Link
              key={item.path}
      ...
      >
        ...
        >
          <div className="flex items-center space-x-4">
            ...
            <h2 className="text-xl font-semibold text-[#263238] truncate">
              Welcome, {user?.name}
            </h2>
          </div>
